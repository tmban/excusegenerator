...
const STYLES = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .bottom-actions { display: flex; gap: 8px; flex-direction: row; }
  ...
  @media (max-width: 600px) {
    ...
    .header-logo { white-space: normal; max-width: 140px; line-height: 1.25; }
  }
`;
...
function ExcuseCard({ ex, idx, iCol, c, d, rating, onRate, onSave, alreadySaved, onCopy, copied }) {
  ...
  // Card bg alternates using Celtics palette
  const cardBg = d

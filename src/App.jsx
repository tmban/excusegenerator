        ...
        {!loading && !excuse && (
          <div className="fade-up">
            <div style={{ marginBottom: 32 }}>
              <div style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: "2rem", color: c.text, lineHeight: 1.15, marginBottom: 8 }}>
        ...
        {!loading && excuses.length > 0 && (
          <div className="fade-up">
            ...
            <div style={{ marginBottom: 22 }}>
              <div style={{ fontSize: "0.65rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: c.textFaint, marginBottom: 5 }}>
              ...
              <div style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: "1.3rem", color: c.text, lineHeight: 1.25 }}>{situation}</div>
            </div>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              ...
              <button onClick={() => { setExcuses([]); setRatings({}); }}
